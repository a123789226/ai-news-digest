...
func buildRequest(modelName string, candidates []pipeline.Candidate) requestEnvelope {
	...
	prompt := "Select the top 1 to 3 AI news items from the candidates below. Prefer practical software-engineering updates first. If enough strong candidates exist, at least 2 selected items should be directly useful to software engineers, such as API changes, SDKs, CLIs, developer tooling, coding assistants, agent frameworks, open-source releases, integrations, or changes to implementation workflow. A third item may cover major model launches, API pricing, or significant company moves. Return strict JSON with this exact shape: {\"items\":[{\"TitleEN\":\"...\",\"SummaryZH\":\"...\",\"WhyItMattersZH\":\"...\",\"Source\":\"...\",\"URL\":\"...\"}]}. Preserve the original English title. Write SummaryZH and WhyItMattersZH in Traditional Chinese. Avoid generic wording. Do not invent facts. If fewer than 3 strong items exist, return fewer. Candidates: " + string(candidateJSON)
